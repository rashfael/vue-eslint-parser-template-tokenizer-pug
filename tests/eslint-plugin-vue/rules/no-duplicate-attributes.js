// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-duplicate-attributes.js @2022-03-19T13:08:36.672Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/no-duplicate-attributes')
...
div
  div(foo, :bar, baz)
    ...
    {
      filename: 'test.vue',
      code: `<!-- CONVERT ERROR -->Duplicate attribute.<template><div><div @click="foo" @click="bar"></div></div></template>`
    },
    {
      filename: 'test.vue',
      code: `<template lang="pug">
