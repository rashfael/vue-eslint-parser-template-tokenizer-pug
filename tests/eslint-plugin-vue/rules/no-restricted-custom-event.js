// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-restricted-custom-event.js @2022-03-19T14:17:43.672Z
/**
 * @author Yosuke Ota
 */
'use strict'
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/no-restricted-custom-event')
  ...
  valid: [
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">button(@click="\$emit('click')")</template>
      <script>
      export default {
        methods: {
          handleClick() {
...
button(@click="emit('ignore')")
  ...
  invalid: [
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">button(@click="\$emit('bad')")</template>`,
