// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/order-in-components.js @2022-03-19T14:17:43.754Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/order-in-components')
  ...
  invalid: [
    ...
    },
    {
      ...
      parserOptions: { 
        ecmaVersion: 6,
        sourceType: 'module',
        ecmaFeatures: { jsx: true , templateTokenizer: { pug: path.resolve(__dirname, '../../../')}}
      },
      output: `
        export default {
          name: 'app',
