// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/component-tags-order.js @2022-03-19T13:08:36.596Z
/**
 * @author Yosuke Ota
 */
'use strict'
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/component-tags-order')
const RuleTester = require('eslint').RuleTester
const assert = require('assert')
const { ESLint } = require('../../fixtures/eslint-plugin-vue/tests/eslint-compat')
...
const eslint = new ESLint({
  ...
  useEslintrc: false,
  plugins: { vue: require('../../fixtures/eslint-plugin-vue/lib/index') },
  fix: true
})
