// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/this-in-template.js @2022-03-19T14:17:43.797Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/this-in-template')
...
div(:class="\${suggestionPrefix(
  ...
  options
    ...
    },
    {
      ...
      output: `<template lang="pug">
div(:class="{foo: \${suggestionPrefix(
  prefix,
  options
)}foo}")
</template><!-- ${comment} -->`,
...
div(v-if="\${suggestionPrefix(
  ...
  options
    ...
    },
    {
      ...
      output: `<template lang="pug">
div(v-for="foo in \${suggestionPrefix(
  prefix,
  options
)}bar")
</template><!-- ${comment} -->`,
