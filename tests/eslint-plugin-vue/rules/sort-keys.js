// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/sort-keys.js @2022-03-19T14:17:43.788Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/sort-keys')
...
ruleTester.run('sort-keys', rule, {
  valid: [
    ...
    { code: 'let {a, b} = {}', options: [], parserOptions: {  ecmaVersion: 6 , templateTokenizer: { pug: path.resolve(__dirname, '../../../')}} },
