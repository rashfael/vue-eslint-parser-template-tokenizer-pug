// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/first-attribute-linebreak.js @2022-03-19T14:17:43.563Z
/**
...
ruleTester.run('first-attribute-linebreak', rule, {
  valid: [
    {
      code: `
      <template lang="pug">component</template>`
    },
    {
      code: `
      <template lang="pug">
component(name="John Doe", age="30", job="Vet")
