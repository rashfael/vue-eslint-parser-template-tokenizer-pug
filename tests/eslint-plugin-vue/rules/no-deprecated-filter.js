// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-deprecated-filter.js @2022-03-19T14:17:43.605Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/no-deprecated-filter')
...
ruleTester.run('no-deprecated-filter', rule, {
  valid: [
    ...
    },
    {
      ...
      parserOptions: { 
        vueFeatures: { filter: false , templateTokenizer: { pug: path.resolve(__dirname, '../../../')}}
      }
    }
  ],
