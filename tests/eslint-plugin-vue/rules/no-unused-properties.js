// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-unused-properties.js @2022-03-19T14:17:43.717Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/no-unused-properties')
...
tester.run('no-unused-properties', rule, {
  valid: [
    ...
    // properties used in a template expression
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">div {{ count1 + count2 }}</template>
        <script>
          export default {
            props: ['count1', 'count2']
          };
    ...
    // a property used in v-if
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">div(v-if="count > 0")</template>
        <script>
          export default {
            props: {
              count: {
    ...
    // a property used in v-for
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">div(v-for="color in colors") {{ color }}</template>
        <script>
          export default {
            props: {
              colors: {
    ...
    // a property used in v-html
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">div(v-html="message")</template>
        <script>
          export default {
            props: ['message']
          };
    ...
    // a property passed in a component
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">counter(:count="count")</template>
        <script>
          export default {
            props: ['count']
          };
    ...
    // a property used in v-on
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">button(@click="alert(count)")</template>
        <script>
          export default {
            props: ['count']
          };
    ...
    // data used in v-model
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">input(v-model="count")</template>
        <script>
          export default {
            data () {
              return {
    ...
    // data used in v-on
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">button(@click="count++")</template>
        <script>
          export default {
            data () {
              return {
    ...
    // computed property used in v-model
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">input(v-model="fullName")</template>
        <script>
          export default {
            data() {
              return {
    ...
    // async data passed in a component
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">counter(:count="foo")</template>
        <script>
          export default {
            asyncData() {
              return {
    ...
    // ignores unused data when marked with eslint-disable
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">div {{ cont }}</template>
        <script>
          export default {
            data () {
              return {
    ...
    // deep data
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">| {{ foo.baz.b }}</template>
        <script>
          export default {
            data() {
              return {
...
| {{ foo.baz }}
    ...
    },
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">Foo(:param="{ a: foo.bar }")</template>
    ...
    },
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">Foo(:class="[ foo.bar ]")</template>
    ...
    //style vars
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">.text hello</template>
  ...
  invalid: [
    ...
    // deep data
    {
      filename: 'test.vue',
      code: `
        <template lang="pug">| {{ foo.baz.a }}</template>
        <script>
          export default {
            data() {
              return {
...
describe('`vue/no-unused-properties` and `vue/no-unused-components` should not conflict.', () => {
  ...
  linter.defineRule(
    ...
    require('../../fixtures/eslint-plugin-vue/lib/rules/no-unused-components')
  )
