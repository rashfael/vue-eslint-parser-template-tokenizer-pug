// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/attributes-order.js @2022-03-19T14:17:43.531Z
/**
...
tester.run('attributes-order', rule, {
  valid: [
    ...
    },
    {
      ...
      code: `<!-- CONVERT ERROR -->Duplicate attribute.<template>
          <div
            class="foo"
            class="bar">
          </div>
