// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/custom-event-name-casing.js @2022-03-19T14:17:43.557Z
/**
 * @author Yosuke Ota
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/custom-event-name-casing')
  ...
  valid: [
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">input(@click="\$emit('foo-bar')")</template>
      <script>
      export default {
        setup(props, context) {
          return {
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">input(@click="\$emit('update:fooBar', value)")</template>
      <script>
      export default {
        setup(props, {emit}) {
          return {
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">input(@click="emit('fooBar')")</template>
      <script>
      export default {
        setup(context) {
          return {
...
input(@click="\$emit('click:row')")
  ...
  invalid: [
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">input(@click="\$emit('input/update')")</template>
      <script>
      export default {
        setup(props, context) {
          return {
