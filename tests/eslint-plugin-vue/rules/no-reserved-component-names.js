// SKIP AUTOGENERATION
// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-reserved-component-names.js @2022-03-19T13:00:09.079Z
/**
...
const rule = require('../../fixtures/eslint-plugin-vue/lib/rules/no-reserved-component-names')
const RuleTester = require('eslint').RuleTester

const htmlElements = require('../../fixtures/eslint-plugin-vue/lib/utils/html-elements.json')
  ...
  valid: [
    ...
    },
    {
      ...
      code: `
        <script>
          export default {
            template: '<template lang="pug">div</template>'
          }
        </script>
      `,
    ...
    },
    {
      ...
      code: `
        <script>
          export default {
            template: '<template lang="pug">div: slot</template>'
          }
        </script>
      `,
      parser: require.resolve('vue-eslint-parser'),
